...
public class BookController {
	...
	public Book updateBook(@PathVariable(value="id") Long id, @RequestBody Book bookDetails)
	{
		...
		book_new.setCategory(bookDetails.getCategory());
		book_new.setPages(bookDetails.getPages());
		book_new.setPublicatation(bookDetails.getPublicatation());
		book_new.setPrice(bookDetails.getPrice());
